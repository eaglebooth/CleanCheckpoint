...
- [Studionet Security v2 runtime matrix](./STUDIONET_SECURITY_V2.md) records happy settlement, semantic consensus with verified integrity, replay rollback without mutation, tamper fail-closed behavior, recovery refunds, and final custody conservation for `0xfc6c3abc5C202A37c8389a96b15165f2Fc5D7e1c`.
